      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-primary-600"> Education & Opportunity</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Connect with short-term jobs, remote internships, and apprenticeships while accessing 
            free upskilling resources. Designed for individuals from low-income communities and recent graduates.
          </p>
